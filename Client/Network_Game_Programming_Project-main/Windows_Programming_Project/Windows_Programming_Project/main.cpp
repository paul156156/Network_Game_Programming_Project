...
DWORD WINAPI RecvThread(LPVOID arg)
{
    ...
    size_t packSize[] = { sizeof(SC_MOVE_PLAYER) - 1 };
    ...
    while (true)
    {
        ...
        // 1byte씩 받아서 패킷 넘버를 확인한다.
        if (packSize[packetType] - 1 > 0) {
        ...
        default:
            cout << "잘못된 패킷타입: " << (USHORT)arg << " , " << (int)packetType << endl;
            break;
        }
    }
}
