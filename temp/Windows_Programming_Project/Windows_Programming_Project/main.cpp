...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMessage, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        case 3: HandleRestart(hWnd, gameManager->GetBullets(), gameManager->GetEnemies(), gameManager->GetPlayer(), score, specialAttackCount, gameStarted, showMenu, paused, gameOver, winWidth, winHeight); break;
